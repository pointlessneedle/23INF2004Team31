...
// Based on https://pdf1.alldatasheet.com/datasheet-pdf/view/439619/HOLTEK/HT16K33.html
// And built to be suitable for ht16k33_i2c
...
void i2c_slave_init_Caller_ht16k33(){

    i2c_slave_init(i2c0, SLAVE_ADDR, &ht16k33_i2c_slave_handler);

}

// Converts char to pattern
...
// Run a string across the ht16k33 for set interval timing
...
static void run_ht16k33_master(){
    ...
    // Sets the display set of ht16k33
    ht16k33_display_set(0, 0);
    ht16k33_display_set(1, 0);
    ht16k33_display_set(2, 0);
    ht16k33_display_set(3, 0);

    // Runs a while loop of actions to be sent to ht16k33, based on ht16k33_i2c
    while(1){
...
//     // Creates a slave and master on the same pico w
//     setup_slave();
//     run_ht16k33_master();
